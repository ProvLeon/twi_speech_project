...
export const RECORDING_SCRIPT: ScriptPrompt[] = [
  ...
  { id: 'ScriptD_2', type: 'scripted', text: 'Mekɔɔ Kumasi nanso manhu Kofi.', meaning: 'I went to Kumasi but I didn\'t see Kofi.' },
  { id: 'ScriptD_3', type: 'scripted', text: 'Ɔkɔm de me enti merepɛ biribi adi.', meaning: 'I am hungry so I am looking for something to eat.' },
  { id: 'ScriptD_4', type: 'scripted', text: 'Ɔbaa ha efirisɛ ɔpɛ sɛ ɔhu wo.', meaning: 'He/She came here because he/she wants to see you.' },
  { id: 'ScriptD_5', type: 'scripted', text: 'Akwadaa w\'atenase no yɛ me ba.', meaning: 'The child who sat down is my child.' },
  { id: 'ScriptD_6', type: 'scripted', text: 'Ɔkae sɛ ɔbɛba ɔkyena anɔpa.', meaning: 'He/She said that he/she will come tomorrow morning.' },
  ...
  { id: 'ScriptD_9', type: 'scripted', text: 'Me nuabarima panyin yɛ ɔkyerɛkyerɛni.', meaning: 'My elder brother is a teacher.' },
  { id: 'ScriptD_10', type: 'scripted', text: 'Me adamfo pa na ɔboa me berɛ a mehia mmoa.', meaning: 'My best friend is the one who helps me when I need help.' },
  { id: 'ScriptD_11', type: 'scripted', text: 'M\'ani agye sɛ mahu wo nnɛ.', meaning: 'I am happy to see you today.' },
  { id: 'ScriptD_12', type: 'scripted', text: 'Adwuma no yɛ den nanso ɛho hia.', meaning: 'The work is difficult but it is important.' },
  { id: 'ScriptD_13', type: 'scripted', text: 'Mɛnsusu sɛ ɔbɛtumi awie nnɛ.', meaning: 'I don\'t think he/she can finish today.' },
  { id: 'ScriptD_14', type: 'scripted', text: 'Ɛwɔ sɛ yɛ boa yɛn ho yɛn ho.', meaning: 'We must help each other.' },
  { id: 'ScriptD_15', type: 'scripted', text: 'Me werɛ aho paa.', meaning: 'I am very sad.' },
  { id: 'ScriptD_16', type: 'scripted', text: 'M\'abrɛ paa.', meaning: 'I am very tired.' },
  { id: 'ScriptD_17', type: 'scripted', text: 'Ɔpanyin no pɛ sɛ ɔne wo kasa.', meaning: 'The boss wants to talk to you.' },
  ...
  { id: 'ScriptD_25', type: 'scripted', text: 'Mpɛn ahe na wodidi wɔ da mu?', meaning: 'How many times do you eat in a day?' },
  ...
  { id: 'ScriptD_28', type: 'scripted', text: 'Berɛ a na me re didi no, me nua no baeɛ.', meaning: 'While I was eating, my sibling came.' },
  ...
  { id: 'Spontaneous_4', type: 'spontaneous', text: 'Ka asɛm bi a ɛsi nnansa yi ara a ɛmaa w\'ani gyei paa anaasɛ ɛmaa wo werɛ hoeɛ ho asɛm kyerɛ me.Adɛn nti na ɛte saa?. (Tell me about something that happened recently that made you very happy or very sad.Why did it make you feel that way ?)' },
